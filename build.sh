...
tool_compiler_flags="-std=gnu2x -O2 -fdiagnostics-absolute-paths -g -I$root -I$root/core"
...
if [ $need_to_build_extract_define -eq 1 ]; then
	...
	clang $tool_compiler_flags "$root/core/tools/tools_extract_define_main.c" -o $extract_define_tool_name
	status_code=$?
