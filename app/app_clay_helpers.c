...
#define UI_R32(pixels) RoundR32((r32)(pixels) * app->settings.uiScale * platformInfo->sappDpiScale)
#define UI_U16(pixels) (u16)RoundR32i((r32)(pixels) * app->settings.uiScale * platformInfo->sappDpiScale)
#define UI_BORDER(pixels) MaxU16(((pixels) > 0) ? (u16)1 : (u16)0, (u16)RoundR32i((r32)(pixels) * app->settings.uiScale * platformInfo->sappDpiScale))
